...
var cnItems = {
    ...
    "": "",
    "": "",
    "Your goal is to survive for as long as possible while defeating bosses and unlocking new items and units by completing achievements. You can check your progress of your achievements on the main menu. Good luck!": "你的目标是在打败boss并通过完成成就解锁新道具和单位的同时尽可能长时间地生存下去。你可以在主菜单上查看你的成就进度。祝你好运！",
    "You just chose your first Item of Power. You can drag it around in your party area by using your mouse.": "你刚选了你的第一件异能道具。你可以在你的队伍区域用鼠标拖动它。",
    "When your Items of Power activate, they will apply their effects to whichever unit(s) they are overlapping. Try to position your items so they overlap as many units as possible.": "当你的异能道具激活时，它们会对与之重叠的单位产生效果。试着将你的道具放置在尽可能多的单位上。",
