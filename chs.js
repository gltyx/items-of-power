...
var cnItems = {
    ...
    "Rogue: Attack a random enemy for 30% POW. Steal 10% of their POW for the rest of this battle.": "盗贼: 攻击一个随机的敌人并造成 30% 力量伤害。在剩下的战斗休息时偷取他们 10% 的力量伤害。",
    ...
    "Hammer": "锤子",
    "Tip: Each of your units have different abilities. Hover over them to see what they do.": "提示：您的每个单位都有不同的能力。 将鼠标悬停在他们身上，看看他们可以做什么。",
    "Tip: Your units will slightly resize based on their total stats. This may make it easier or harder to stack more Items of Power on them.": "提示：您的单位将根据其总属性略微调整大小。 这可能会使在它们上堆叠更多的能量物品变得更容易或更难。",
    "Looks like you're blasting off again!": "看来你又要发火了！",
    "Rogue": "盗贼",
    "Sticky Fingers": "隔空取物",
    "You gotta let me join.": "你得让我加入。",
    "Attack a random enemy for 30% POW. Steal 10% of their POW for the rest of this battle.": "随机攻击一名敌人并造成 30% 力量伤害。 在这场战斗的休息时间内窃取他们 10% 的 力量。",
    "Monk: Attack up to 2 random enemies for 20% POW. Has a 50% chance to stun for 2 seconds.": "武僧：攻击最多 2 个随机敌人并造成 20% 力量伤害。 有 50% 的几率眩晕 2 秒。",
