...
var cnItems = {
    ...
    "Amulet": "护身符",
    "Amulet: Revives fallen unit with 1 HP every 10 seconds": "护身符：每10秒用1 hp恢复堕落的单位",
    "Artificer: Attack the enemy with the highest HP for 35% POW. All POW stat gains are doubled. When this unit falls, it loses 5% POW.": "Artificer：以35％POW的最高HP攻击敌人。所有POW统计收益都翻了一番。当该单元掉落时，它会失去5％的POW。",
    "Attack a random enemy for 30% POW. All allies gain 5% POW for the rest of this battle.": "以30％的战俘攻击随机敌人。所有队友在本次战斗的其余部分获得了5％的战俘。",
    "Attack a random enemy for 60% POW. All allies gain 10% POW, SPD, and HP for the rest of this battle.": "以60％的战俘攻击随机敌人。在本次战斗的其余部分，所有队友都获得了10％的POW，SPD和HP。",
    ...
    "1): +1 POW, +1 SPD every 1 second. Resets unit's ability charge": "1）：+1 POW，+1 SPD每1秒钟。重置单位的能力充电",
    ...
    "ehehehehe": "额呵呵呵呵",
    "For killing The Inevitable you unlocked the Books. They have higher stat bonuses than other items, but they reset your unit's ability bar every time they activate which makes them unable to attack in battle.": "为了杀死不可避免的书，您解锁了书籍。它们具有比其他项目更高的统计奖金，但是每次激活时都会重置您的单位能力栏，这使他们无法在战斗中攻击。",
    ...
    "Revives fallen unit with 1 HP every 10 seconds": "每10秒用1 hp 1 hp恢复堕落的单位",
    ...
    "The Inevitable": "不可避免",
    "Tip: You can pause the game by pressing the button at the bottom of the screen. This is useful for adjusting your items between battles.": "提示：您可以通过按屏幕底部的按钮来暂停游戏。这对于在战斗之间调整项目很有用。",
    "Treefolk": "树妖",
    "Warlord": "战争领主",
