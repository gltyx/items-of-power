                    ...
                    switch (this.saveGame(), this.state = e, null !== (t = this.enemies) && void 0 !== t && t.forEach(function (e) {
                        ...
                        case "SHOP":
                            ...
                            I(0, 1) < a ? (this.enemies = [new tt(this, "HAG", !1, ue("HAG"))], this.selected = !1, this.moveEnemiesToPositions(function () {
                                n.trail.stopMoving(), n.hud.setInfoText("被诅咒!");
                        ...
                        case "RECRUIT":
                            ...
                            this.enemies = [new tt(this, s, !1, o)], this.recruited = !1, this.moveEnemiesToPositions(function () {
                                var e;
                                n.trail.stopMoving(), n.hud.setInfoText("招募"), n.hud.setEnemies(n.enemies, "RECRUIT"), n.recruitBubble = new Rt(n, n.enemies[0], null !== (e = T(be[e = s])) && void 0 !== e ? e : T(["May I join your party?", "Can I please join your party?", "Please let me join. I'll die out there alone!", "You gotta let me join.", "If you don't let me join, you're gonna regret it."]))
                        ...
                        case "BATTLE":
                            ...
                            this.enemies = y(r).map(function () {
                                ...
                                n.inCombat = !0, n.events.emit("ENTER_COMBAT"), n.trail.stopMoving(), n.hud.setInfoText("战斗!"), n.hud.setEnemies(n.enemies), n.allies.forEach(function (e) {
                        ...
                        case "BOSS":
                            ...
                            this.enemies = r.map(function (e) {
                                ...
                                n.inCombat = !0, n.events.emit("ENTER_COMBAT"), n.trail.stopMoving(), n.hud.setInfoText("Boss战!"), n.hud.setEnemies(n.enemies), n.allies.forEach(function (e) {
                                    return e.startAbility()
                                }), n.enemies.forEach(function (e) {
                                    e.startAbility(), e.addListener("dead", n.checkWin, n)
                                }), n.startEnrageEvent()
    ...
    var Ut = !1,
        Wt = function () {
            ...
            return n(t, [{
                ...
                value: function () {
                    var t = this;
                    this.loading = this.add.text(at.x, at.y, "加载中...", {
                        fontSize: "72px"
